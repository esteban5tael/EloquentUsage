    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
            <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('index')); ?>" aria-current="page">Index</a>
                </li>
...
<?php /**PATH D:\xampp\htdocs\php\laravel\NeoCoders\EloquentUsage\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>